...
(function(ns) {
  ...
  var Piece = function(name, fill, stroke, blockSz) {
    ...
    this.state = 0;
    this.svgItem = new ns.SvgItem(name);
    ...
    this.svgItem.anims["spin"] =
      new ns.Animation(this.svgItem, 0, 0, -90, blockSz * 2, blockSz * 2, 0.2, ns.FRAME_RATE);

    this.svgItem.anims["left"] =
      new ns.Animation(this.svgItem, -blockSz, 0, 0, 0, 0, 0.15, ns.FRAME_RATE);
  ...
  Piece.prototype.setCell = function(i, j) {
    ...
    var r =
      new ns.Rect((this.name + "-" + i) + j, [
        { name: "stroke", value: this.stroke },
        { name: "stroke-width", value: ns.PIECE_STROKE_WIDTH },
        { name: "fill", value: this.fill },
        { name: "opacity", value: ns.PIECE_OPACITY }
      ]);

    r.anims["dissolve"] =
      new ns.Animation(r, 0, 0, 180, this.blockSz / 2, this.blockSz / 2, 0.5, ns.FRAME_RATE, [
