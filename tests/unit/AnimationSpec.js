var SvgItem = require('../../app/js/dev/SvgItem');
var Animation = require('../../app/js/dev/Animation');

describe("Animation", function() {
  describe("start", function() {
    var callback = jasmine.createSpy("callback");

    var item = new SvgItem("item");
    var anim = new Animation(item, 1.0, 2.0, 20.0, 0, 0, 1.0, 20, [], callback);
  ...
  describe("finish", function() {
    var item = new SvgItem("item");
    var anim = new Animation(item, 1.0, 2.0, 20.0, 0, 0, 1.0, 20, []);
